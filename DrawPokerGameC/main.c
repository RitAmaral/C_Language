...
//defined 2 constants for determining whether hands are flushes
#define FALSE 0
#define TRUE 1
...
int main()
{
    ...
    // This function is called outside the do...while loop because the greeting only needs to be displayed once, while everything else in main
    // will run multiple times, depending on how many times the user wants to play.
    ...
    do
    {
        ...
        //these 2 arrays are used to figure out the value of the player's hand. However, they must be zeroed out in case the user plays multiple hands.
...
// and asks the user if they want to keep the card. If they say no, they get a replacement card.
